...
document.addEventListener('DOMContentLoaded', function () {
  ...
  jwt.value = API.jwt;
  var scope = document.getElementById('authorize-scope');
  init(scope.value);
...
function init(scope) {
  var readWrite = scope.indexOf(':readwrite') >= 0;
  var authorizeReadWrite = document.getElementById('authorize-readwrite');
  var authorizeRead = document.getElementById('authorize-read');
  var authorizeThings = document.getElementById('authorize-things');
  var authorizeButton = document.getElementById('authorize-button');
  var authorizeScope = document.getElementById('authorize-scope');
  var authorizeAllThings = document.getElementById('authorize-all-things');
  ...
  var global = scope.split(':')[0] === '/things';
  ...
  fetch('/things', {
    ...
    try {
      for (var _iterator = things[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var included = global || scope.indexOf(thing.href) >= 0;
  ...
  authorizeAllThings.addEventListener('change', function () {
    var authorizeThings = document.querySelectorAll('.authorize-thing');
    var _iteratorNormalCompletion2 = true;
    var _didIteratorError2 = false;
    var _iteratorError2 = undefined;

    try {
      for (var _iterator2 = authorizeThings[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var thingElt = _step2.value;
        var checkbox = thingElt.querySelector('.authorize-thing-included');
  ...
  authorizeButton.addEventListener('click', function () {
    ...
    var urls = []; // read scope from .authorize-thing

    if (authorizeAllThings.checked) {
      urls.push('/things');
    } else {
      var _authorizeThings = document.querySelectorAll('.authorize-thing');
      ...
      try {
        for (var _iterator3 = _authorizeThings[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var thingElt = _step3.value;
    ...
    authorizeScope.value = urls.map(function (url) {
...
/***/ 3:
/*!****************************************************************!*\
  !*** multi ./static/js/check-user.js ./static/js/authorize.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./static/js/check-user.js */"./static/js/check-user.js");
module.exports = __webpack_require__(/*! ./static/js/authorize.js */"./static/js/authorize.js");


/***/ })

/******/ });
//# sourceMappingURL=71ea1be41cdf77dc8352-authorize.js.map