...
var reclamationToken = document.getElementById('reclamation-token');
var createDomainButton = document.getElementById('create-domain-button');
var skipAnchor = document.getElementById('skip-subdomain-anchor');
var errorMessage = document.getElementById('error-setup');
...
function validateDomain() {
  var val = subdomain.value.toLowerCase();
  var re = new RegExp(/^([a-z0-9]|[a-z0-9][a-z0-9-]*[a-z0-9])$/);
  var nsRegex = new RegExp(/^ns\d*$/);
...
function validateEmail() {
  var val = email.value; // eslint-disable-next-line max-len

  var re = new RegExp(/^[^@\s]+@(([a-z0-9]|[a-z0-9][a-z0-9-]*[a-z0-9])\.)+[a-z0-9][a-z0-9-]*[a-z0-9]$/, 'i');
...
function submitForm() {
  displayMessage('Processing...', 'message'); // Call the settings controller to subscribe the domain in the gateway.
  ...
  fetch('/settings/subscribe', {
    ...
    if (response.statusText.indexOf('UnavailableName') > -1) {
      if (response.statusText.indexOf('ReclamationPossible') > -1) {
        var text1 = document.createTextNode('It looks like you\'ve already registered that subdomain. ');
        var text2 = document.createTextNode(' to reclaim it.');
        var reclaim = document.createElement('a');
        ...
        reclaim.onclick = function () {
          ...
          errorMessage.innerHTML = 'Please check your email for a ' + 'reclamation token and paste it above.';
        ...
        displayMessage('This subdomain is already being used. ' + 'Please choose a different one.', 'error');
        return Promise.reject();
      }
    ...
    if (body) {
      displayMessage('Success! Please wait while we redirect you...', 'message');
      setTimeout(function () {
        window.location.replace(body);
      }, 5000);
    } else {
      displayMessage('Error issuing certificate. Please try again.', 'error');
    }
  }, function () {});
}
...
/***/ 5:
/*!********************************************!*\
  !*** multi ./static/js/setup_subdomain.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./static/js/setup_subdomain.js */"./static/js/setup_subdomain.js");


/***/ })

/******/ });
//# sourceMappingURL=71ea1be41cdf77dc8352-setup_subdomain.js.map